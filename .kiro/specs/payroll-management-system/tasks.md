...
- [ ] 7. Request Management module (Leave, Overtime, Cash Advance)
  ...
  - [x] 7.6 `RequestController` (HR-facing) + `EmployeePortalController` request endpoints — **views scaffolded** (`hr/requests` queue via index, `employee/requests/index.php`, `employee/requests/form.php`); controllers and service pending
