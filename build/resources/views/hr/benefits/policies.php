...
<div class="page-head">
    <div>
        ...
        <p>SSS, PhilHealth, and Pag-IBIG policy versions. <a href="<?= $base ?>/hr/benefits">← Back to Benefits</a></p>
    </div>
</div>
        ...
        <?php else: ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form method="post" action="<?= $base ?>/hr/benefits/policies/<?= (int)$p['contribution_policy_id'] ?>/approve" style="display:inline">
