...
- Login uses an email address as the account credential; no separate username field exists. [HR interview 2026-09-21]
- The standard working week is configurable; current Light Diamond configurations are Sunday–Thursday (5 days) or Friday–Thursday (6 days). Saturday is the rest day. [HR interview 2026-09-21]
- Employee archiving is triggered by employment separation; archived employees may be unarchived (rehired) through the controlled rehire workflow. [HR interview 2026-09-21]
